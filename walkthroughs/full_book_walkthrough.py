...
def main():
    ...
    model = "llama3"
    result = query_model(prompt="What do Llamas eat?", model=model)
    print(result)
    ...
    for entry in test_data[:3]:
        ...
        print("\nScore:")
        print(">>", query_model(prompt=prompt, model=model))
        print("\n----------------------")
    ...
    scores = generate_model_scores(test_data, json_key="model_response", model=model)
